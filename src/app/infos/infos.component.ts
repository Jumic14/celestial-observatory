      ...
      case 'hub1':
        ...
        case 'hub2':
          ...
          case 'carouselFr':
            this.info = {
              title: 'Cosmic Carousel',
              content: '<p>Le Cosmic Carousel vous permet d\'explorer trois images aléatoires de la NASA avec leurs descriptions.</p><p>Le bouton "Recharger" vous permet de régénérer instantanément un nouvel ensemble d\'images.</p><p>De plus, d\'un simple clic sur le bouton "Zoom" ou directement sur l\image, vous pouvez visualiser ces images en mode plein écran pour une exploration détaillée des merveilles cosmiques.</p>'
            };
            break;
      default:
        this.info = {
