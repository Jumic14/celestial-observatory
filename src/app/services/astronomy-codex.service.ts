  ...
  codexEntries: CodexEntry[] = [
    {
      ...
      descriptionFr: 'Un type d\'entité physique naturellement présente, association ou structure au sein de l\'univers observable qui est une structure unique, étroitement liée et contiguë, telle qu\'une étoile, une planète, une lune ou un astéroïde.',
    },
    {
      id: 1,
      title: 'Celestial object',
      description: 'A type of naturally occurring physical entity, association, or structure that exists within the observable universe but is a more complex, consisting perhaps of multiple bodies or even other objects with substructures, such as a planetary system, star cluster, nebula, or galaxy.',
      titleFr: 'Objet céleste',
      descriptionFr: 'Un type d\'entité physique naturellement présente, association ou structure qui existe dans l\'univers observable, mais qui est une structure plus complexe, comprenant peut-être plusieurs corps ou même d\'autres objets avec des sous-structures, tels qu\'un système planétaire, un amas d\'étoiles, une nébuleuse ou une galaxie.',
    },
    {
      id: 2,
      title: 'Orbit',
      ...
      titleFr: 'Orbite',
      descriptionFr: 'La trajectoire courbée par la gravité d\'un corps céleste, telle que la trajectoire d\'une planète autour d\'une étoile ou d\'un satellite naturel autour d\'une planète.',
    },
    {
      id: 3,
      title: 'Central Body',
    ...
    },
    {
      ...
      titleFr: 'Apoapside',
      descriptionFr: 'Le point où un corps en orbite est le plus éloigné de son corps central, mesuré en kilomètres.',
    },
    {
      id: 6,
      title: 'Periapsis',
      ...
      titleFr: 'Périapside',
      descriptionFr: 'Le point auquel un corps en orbite est le plus proche de son corps central, mesuré en kilomètres.',
    },
    {
      id: 7,
      ...
      descriptionFr: 'Un paramètre qui détermine dans quelle mesure une orbite s\'écarte d\'un cercle parfait, mesuré en degrés. Pour une orbite elliptique, l\'excentricité varie de plus de zéro à moins de un.',
    },
    {
        id: 8,
        ...
        descriptionFr: 'L\'inclinaison de l\'orbite d\'un objet autour d\'un corps astronomique, exprimée comme l\'angle entre le plan orbital ou l\'axe de direction de l\'objet en orbite et un plan de référence, mesuré en degrés.',
      },
      {
        id: 9,
        title: 'Density',
        ...
        titleFr: 'Densité',
        descriptionFr: 'La masse par unité de volume d\'un corps céleste, exprimée en grammes par centimètre cube (g/cm³)."',
      },
      {
        id: 10,
        title: 'Gravity',
        ...
        titleFr: 'Gravité',
        descriptionFr: 'La force par laquelle un corps céleste attire les objets vers son centre. Dans le contexte des corps célestes, la gravité de surface est l\'accélération gravitationnelle ressentie à la surface de l\'objet, mesurée en mètres par seconde au carré (m/s²).',
      },
      {
        id: 11,
        title: 'Escape',
        ...
        descriptionFr: 'La vitesse nécessaire pour qu\'un objet échappe à l\'attraction gravitationnelle du corps céleste, mesurée en mètres par seconde (m/s).',
      },
      {
        id: 12,
        title: 'Mean Radius',
        ...
        titleFr: 'Rayon moyen',
        descriptionFr: 'Le rayon moyen se réfère au rayon moyen d\'un objet, mesuré en kilomètres. Il représente la taille globale de l\'objet, en tenant compte des variations de sa forme et de sa structure.',
      },
      {
        id: 13,
        title: 'Equa Radius',
        ...
        descriptionFr: 'Le rayon équatorial est la distance du centre d\'un objet jusqu\'à son équateur, mesurée en kilomètres. Il fournit des informations sur la taille de l\'objet le long de son plan équatorial.',
      },
      {
        id: 14,
        title: 'Polar Radius',
        ...
        descriptionFr: 'Le rayon polaire est la distance du centre d\'un objet jusqu\'à son pôle rotationnel, mesurée en kilomètres. Il reflète la taille de l\'objet de son pôle à son axe des pôles.',
      },
      {
        id: 15,
        title: 'Sideral Orbit',
        ...
        descriptionFr: 'Le temps nécessaire à un corps céleste pour effectuer une rotation autour de son corps central, mesuré en jours terrestres.',
      },
      {
        id: 16,
        ...
        descriptionFr: 'Le temps nécessaire à un corps céleste pour effectuer une rotation sur lui-même, mesuré en heures.',
      },
      {
        id: 17,
        ...
        descriptionFr: 'La température moyenne, exprimée à la fois en Kelvin (K) et en Celsius (°C).',
      },
